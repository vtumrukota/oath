...
// is resolved.
Promise.prototype.then = function (successFn, _failureFn) {
  successFn && this.successFns.push(successFn);
  return this;
...
Promise.prototype.catch = function (failureFn) {
  failureFn && this.failureFns.push(failureFn);
};
...
Deferred.prototype.resolve = function (data) {
  ...
  //function (num) {
    ...
    //   done();
    // }
  _.each(this.promise.successFns, function(fn, i) {
    console.log(acc, i);
    fn(this.promise.value);
  });
  // return result;
};
